...
<p align="center"> 
  <img src="image/sushi_shop.png" alt="Sushi Banner" width="100%">
</p>
...
1.  **Клонировать репозиторий:**
    ```bash
    git clone https://github.com/Vasja1142/Coursework.git
    cd Coursework
    ```
...
*   Спасибо моему научному руководителю Петренко А. А. за ценные советы и поддержку.
*   Хочу поблагодарить моего друга Павла Т., чья работа и увлеченность своим "Sushi-shop" послужили главным источником вдохновения для этого проекта.
*   Спасибо сообществам open-source за прекрасные инструменты!

---

*Этот README был создан с любовью к суши и хорошему коду!* 😄
